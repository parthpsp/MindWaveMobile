...
public class DemoActivity extends Activity {
	...
	private Button bt_customized = null;
	...
	private void initView() {
		...
		bt_test = findViewById(R.id.testbt);
		bt_customized = findViewById(R.id.customizesbt);
		...
		bt_customized.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View view) {
				Intent intent = new Intent(DemoActivity.this,Customized.class);
				startActivity(intent);
			}
		});
		...
		bt_test.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View view) {
				Intent intent = new Intent(DemoActivity.this,TestAct.class);
				startActivity(intent);
			}
		});
